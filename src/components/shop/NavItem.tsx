    ...
    <div className="w-full">
      ...
      {path ? (
        <NavLink
          ...
          className={({ isActive }) =>
            `flex items-center justify-between p-2.5 rounded-lg transition ${
              isActive
                ? "bg-alaba-dark-800 text-white"
                : "text-gray-900 hover:bg-alaba-dark-800/50 hover:text-white"
            }`
          }
        >
          <div className="flex items-center space-x-2" onClick={closeNav}>
            <div className="flex divide-x gap-5 divide-gray-300">
