    ...
    return (
      <ul className="space-y-2">
        {products.map((product, index) => (
          <li
            key={index}
            className={`p-2 cursor-pointer rounded-lg gap-4 text-gray-700 even:bg-gray-100 flex justify-between items-center`}
          >
  ...
  return (
    <div className="border-1 border-gray-300 py-4 px-2 rounded-lg">
      <div className="flex items-center justify-between mb-6">
        <h4 className="text-lg text-gray-700">Top Products</h4>
        <Link
          to="/vendor/products"
